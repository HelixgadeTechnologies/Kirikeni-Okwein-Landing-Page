  ...
  return (
    <div className="md:bg-[#005259] bg-white h-screen w-screen flex flex-col justify-center items-center">
      <div className="md:w-[506px] w-full px-5 bg-white rounded-lg h-fit pb-5 text-center">
        <h2 className="text-[33px] font-bold py-5">Sign up</h2>
        <form>
          ...
          <button
            type="submit"
            className="bg-[#005259] rounded-lg text-white py-3 px-4 w-full rounded hover:bg-[#005259] my-3"
          >
            Log In
          </button>
          <div className="my-3">
            <div>
              ...
              <Link href="/auth/login" className="text-[#00B4AF]">
                Sign in
              </Link>
            </div>
          </div>
